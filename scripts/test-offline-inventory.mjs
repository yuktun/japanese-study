...
const coreAssets=[
  ...
  'src/flashcard-review.mjs','src/curriculum-order.mjs','src/pwa-client.mjs','src/japanese-speech.mjs','src/install-app.mjs','data/manifest.json','data/course-map.json',
